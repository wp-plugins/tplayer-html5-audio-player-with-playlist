...
Plugin URI: http://codecanyon.net/item/tplayerhtml5-audio-player-with-playlist-for-wp/12005417
Version: 1.0
Author: Derick Wire
...
function wpt_player_add_admin_iris_scripts( $hook ){
	...
	wp_enqueue_script('wpt_player_settings_script', plugins_url( '/assets/js/wpt_player_settings_script.js', __FILE__ ), array('wp-color-picker'), false, 1 );
}
...
function wpt_player_init(){
	wp_register_script('wpt_player_code_generator_js', plugins_url('/assets/js/wpt_player_code_generator.js', __FILE__));
					...
					<tr>
						...
						<td>
							<fieldset>
								...
								<label for="dwn"><input name="wpt_player_option[dwn]" type="checkbox" id="dwn" <?php echo $wpt_player_option['dwn']=="on" ? 'checked':'';?>><?php _e('Enable Downloading', 'wpt_player'); ?></label><br>
								<label for="autstr"><input name="wpt_player_option[autstr]" type="checkbox" id="autstr" <?php echo $wpt_player_option['autstr']=="on" ? 'checked':'';?>><?php _e('Enable Autostart', 'wpt_player'); ?></label><br>
							</fieldset>
						</td>
					</tr>
					<tr>
